...
router.post("/", async (req, res) => {
  ...
  try {
    const insertQuery = await db.query(
      "INSERT INTO cab_services (guest_id, resort_id, destination_from,  destination_to, price) VALUES ($1, $2, $3, $4, $5)",
    ...
    const insertQuery1 = await db.query(
      "INSERT INTO invoices (reservation_id,total_amount,invoice_date) VALUES ($1,$2,$3)",
